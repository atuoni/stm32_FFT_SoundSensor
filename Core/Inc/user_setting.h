 ...
 * @version V1.0.0
 * @date    22/06/2020
 * @brief   Conjunto configurações de usuário para interfacear com os controladores
 * 			de LCD mais populares no mercado.
 * 		 	Adaptado de https://controllerstech.com/interface-tft-display-with-stm32/
 ******************************************************************************
 * @attention
 *
 * Este arquivo está compatibilizado com o kit ST NUCLEO-F446RE,
...
/* Definição da resolução do LCD *********************************************/
#define  WIDTH    ((uint16_t)240)
#define  HEIGHT   ((uint16_t)320)

/* Definição de uma função de delay de microssegundo *************************/
/* Essa função precisa ser ajustada no arquivo tft.c
 * Procure pela função static void delay (uint32_t time)
 */

/* Configuração de macros para os pinos de dados ******************************
 *
...
/* Configuração de atraos para leitura e escita de acorddo com o clock do processador*/
/* ******************* For 180 MHz *******************************************/
